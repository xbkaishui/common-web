package cn.gniic.common.converter;

import com.baomidou.mybatisplus.core.toolkit.ClassUtils;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import cn.gniic.common.modelmapper.jdk8.Jdk8Module;
import cn.gniic.common.modelmapper.jsr310.Jsr310Module;
import cn.gniic.common.modelmapper.jsr310.Jsr310ModuleConfig;
...
public class BeanConverter {
    ...
    public static <T> List<T> convert(Class<T> clazz, List<?> list) {
        return CollectionUtils.isEmpty(list) ? Collections.emptyList()
                : list.stream().map(e -> convert(clazz, e)).collect(
                        Collectors.toList());
    }
