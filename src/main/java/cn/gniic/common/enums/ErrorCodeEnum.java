...
public enum ErrorCodeEnum {
    ...
    SIGN_CHECK_FAILED(HttpServletResponse.SC_SERVICE_UNAVAILABLE, false, "SIGN_CHECK_FAILED")
    ;
    ...
    public static ErrorCodeEnum getErrorCode(String errorCode) {
        ...
        throw new RuntimeException("Error: Unknown errorCode, or do not support changing errorCode!\n");
    }
